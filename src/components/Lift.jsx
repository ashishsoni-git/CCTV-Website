...
const Lift = () => {
  return (
    <div className="flex flex-col gap-6 justify-center p-6 md:p-16">
      <p className="text-3xl md:text-4xl font-extrabold text-[#050748] text-center lg:text-right">
        LIFT AND ELEVATORS
      </p>
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center lg:items-start">
        ...
        <div className="w-full lg:w-1/2">
          <img
            src="https://media.istockphoto.com/id/1206509512/photo/technician-repairing-elevator.jpg?s=612x612&w=0&k=20&c=TAialB0heY7gWhdiF3llKb9LU9GMGfIlbX0QEnuZwXw="
            alt="lift_image"
            className="w-full max-w-md lg:max-w-lg rounded-lg shadow-md object-cover mx-auto"
          />
        </div>
      </div>
    </div>
